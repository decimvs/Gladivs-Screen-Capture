 ...
 */
public class CaptureRegionOptionButtons extends OptionButtonsBase implements Initializable {
    
    @FXML
    private Button btnSave, btnSaveAs, btnReSelect, btnSelectRegion, btnExit;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        btnSelectRegion.addEventHandler(ActionEvent.ACTION, onBtnSelectRegionActionPerformed);
    }
    ...
    private EventHandler<ActionEvent> onBtnSelectRegionActionPerformed = new EventHandler<ActionEvent>() {
        @Override
        public void handle(ActionEvent event) {
            setSelectedRegion();
        }
